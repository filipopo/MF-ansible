  ...
  <div class="big left">
    <div class="grid-container">
      ...
      <div class="grid-item b">
        Mobile Forces is a first-person shooter video game developed by Rage Software using the Unreal Engine and published by Majesco Entertainment, the game has eight different game modes:<br>
        <br>
